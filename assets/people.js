...
window.PEOPLE = [
  ...
  { name:'Идиев Ильхом', nameLat:'Ilxom Idiyev',
    role:'Председатель Набсовета АО «MULTICARD PAYMENT» / Директор ООО «RAHMAT TECH»',
  ...
  { name:'Халиулина Юлия', nameLat:'Yuliya Khaliulina',
    role:'Юрист',
    desc:'Юридическое сопровождение, договорная работа',
    block:'control', type:'staff', ini:'ХЮ',
    photoFile:null, tg:'@JuliaKhali', phone:'+998998604884' },
  ...
  { name:'Аглямова Эльвира', nameLat:'Elvira Aglyamova',
    role:'Начальник отдела развития кредитных продуктов',
  ...
  { name:'Рахматуллаев Азамат', nameLat:'Azamat Rakhmatullayev',
    ...
    desc:'Развитие направления Multidriver',
  ...
  { name:'Кан Богдан', nameLat:'Bogdan Kan',
    role:'Руководитель техподдержки',
    desc:'Техническая поддержка пользователей и продуктов',
    block:'products', type:'staff', ini:'КБ',
    photoFile:null },
